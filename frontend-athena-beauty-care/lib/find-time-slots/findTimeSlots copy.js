...
export const findTimeSlots = async () => {
    ...
    const treatments = [
        ...
        {
            title: "Epilation - first time",
            duration: 55,
            stylist: "Soudi Hempshire",
            stylists: ["samsur.rahman3311@gmail.com", "rafez.developer@gmail.com", "rafez3311@gmail.com"],
            email: "rafez.developer@gmail.com"
        },
        {
            ...
            dateTimeArray.forEach((dateTime, dateTimeIndex) => {
                ...
                for(let i = 0; i < calendarEvent.events.length; i++) {
                    ...
                    if(dateTime.date === eventDate) {
                        ...
                        // const time = await findBusyTimes(eventDuration, startingMinute, startingHour);
                ...
                // if(!busyTimes.length) {
                //     for(let k = 0; k < dateTime.defaultTime.length; k++) {
                //         freeTimes.push(dateTime.defaultTime[k]);
                //     }
                // } else {
                //     for(let k = 0; k < dateTime.defaultTime.length; k++) {

                //         if(!busyTimes.includes(dateTime.defaultTime[k])) {
                //             freeTimes.push(dateTime.defaultTime[k]);
                //         }
                //     }
                // }
