...
export default function SideNav ({ calendarAccessCode }) {
    ...
    const redirectUri = "redirect_uri=http://localhost:3000/admins/auth";
        ...
        <div className={styles.sidenav}>
            ...
            <div className={styles.sidenav_content}>
                ...
                <Link href={googleOauthEndpoint}>
                    <a 
                        style = {{display: calendarAccessCode === "" ? "block" : "none"}}
                    >
