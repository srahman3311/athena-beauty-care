...
/* harmony export */   "fetchStylistsEvents": function() { return /* binding */ fetchStylistsEvents; }
/* harmony export */ });
...
var fetchStylistsEvents = /*#__PURE__*/function () {
  ...
  return function fetchStylistsEvents() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "findBusyTimes": function() { return /* binding */ findBusyTimes; }
/* harmony export */ });
/* module decorator */ module = __webpack_require__.hmd(module);
//
var findBusyTimes = function findBusyTimes(eventDuration, startingMinute, startingHour) {
  for (var i = 1; i < Math.ceil(eventDuration / 15); i++) {
    var interval = 15 * i + startingMinute;
    ...
    if (hour < 10) return "0".concat(hour, ":").concat(interval);
    return "".concat(hour, ":").concat(interval);
  }
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getEventDetails": function() { return /* binding */ getEventDetails; }
/* harmony export */ });
/* module decorator */ module = __webpack_require__.hmd(module);
//
var getEventDetails = function getEventDetails(event) {
  var eventDate = event.start.dateTime.substring(0, event.start.dateTime.indexOf("T"));
  var startIndexOfT = event.start.dateTime.indexOf("T");
  var endIndexOfT = event.end.dateTime.indexOf("T");
  var startTime = event.start.dateTime.substring(startIndexOfT + 1, startIndexOfT + 6);
  var endTime = event.end.dateTime.substring(endIndexOfT + 1, endIndexOfT + 6);
  var startingHour = Number(startTime.substring(0, 2));
  var endingHour = Number(endTime.substring(0, 2));
  var startingMinute = Number(startTime.substring(3, 5));
  var endingMinute = Number(endTime.substring(3, 5));
  var startTimeInMinute = startingHour * 60 + startingMinute;
  var endTimeInMinute = endingHour * 60 + endingMinute;
  ;
  var eventDuration = endTimeInMinute - startTimeInMinute;
  return {
    eventDate: eventDate,
    startTime: startTime,
    endTime: endTime,
