...
import ListHeader from "../../components/admins/admin-list/list/ListHeader";
import ListBody from "../../components/admins/admin-list/list/ListBody";
import ViewLimit from "../../components/admins/admin-list/list/ViewLimit";
import Search from "../../components/admins/admin-list/list/Search";
import StylistAddForm from "../../components/admins/admin-list/StylistAddForm";
// Stylesheet
